...
CREATE TABLE `persona` (
  ...
  CONSTRAINT `FK_S1` FOREIGN KEY (`subscripcion`) REFERENCES `subscripcion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `persona_categoria` (
  ...
  CONSTRAINT `FK_CATEGORIA` FOREIGN KEY (`categoria`) REFERENCES `categoria` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2021-11-11 20:21:06
